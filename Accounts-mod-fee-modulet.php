                            ...
                            <div>
                                <div class="card-box">
                                 ...
                                 <div>
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30" style="text-align: center; font-size: 22px; padding: 10px">Fee Module</h4>
                                    ...
                                    <form action="#" data-parsley-validate="" novalidate="">
                                        ...
                                        <div class="form-group">
                                            <label for="userName">Seat no. *</label>
                                            <input type="text" name="nick" parsley-trigger="change" required="" placeholder="Enter Subject" class="form-control" >
                                        </div>

                                        <div class="form-group">
                                            <label for="pass1">E-mail *</label>
                                            <input id="pass1" type="e-mail" placeholder="enter e-mail" required="" class="form-control" data-parsley-id="8">
                                        </div>

                                        <div class="form-group">
                                            <label for="pass1">Fee *</label>
                                            <input id="pass1" type="number" placeholder="Roll number" required="" class="form-control" data-parsley-id="8">
                                        </div>

                                        <div class="form-group">
                                            <label for="pass1">Date *</label>
                                            <input id="pass1" type="date" placeholder="" required="" class="form-control" data-parsley-id="8">
                                        </div>
...
<!--                                         <div class="form-group">
                                        ...
                                        <div class="form-group text-right m-b-0">
                                            <button class="btn btn-primary waves-effect waves-light" type="print">
                                                Print
                                            </button>
